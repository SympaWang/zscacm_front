...
const form = reactive({ studentNum: '', oldPassword: '', newPassword: '' })
...
function onSubmit() {
  ...
  loading.value = true
  api.forgetPassword({ studentNum: form.studentNum, oldPassword: form.oldPassword, newPassword: form.newPassword })
    .then(o => {
      loading.value = false
      info.value = ''
      if (o.data.code != 200) {
