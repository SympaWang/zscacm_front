...
const routes = [
  ...
  { path: '/problems', component: () => import('../views/Problems.vue'), meta: { title: 'CF题目检索' } },
  { path: '/problems/acwing', component: () => import('../views/AcwingProblems.vue'), meta: { title: 'AcWing题目检索' } },
  ...
  { path: '/center/history', component: () => import('../views/PersonalHistory.vue'), meta: { title: '提交历史' } },
